    ...
    def execute_query(self, query_string):
        ...
        if platform.mac_ver()[0] != '':
            ...
            try:
                ...
                with jaydebeapi.connect('com.teradata.jdbc.TeraDriver','jdbc:teradata://{url}/USER={user},PASSWORD={password}'
                                        .format(url=self.host, user=self.username, password=self.password)) as conn:
                    with conn.cursor() as cur:
                        print "executing query"
